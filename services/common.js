...
let transporter = nodemailer.createTransport({
  ...
  auth: {
    user: '2021002170210032@ljku.edu.in', // gmail
...
exports.sendMail = async function ({ to, subject, text, html }) {
  let info = await transporter.sendMail({
    from: '"eBuy" <2021002170210032@ljku.edu.in>', // sender address
    to,
    subject,
    text,
    html
            ...
            <td align="left" bgcolor="#ffffff" style="padding: 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">
              <table border="0" cellpadding="0" cellspacing="0" width="100%">
                ...
                ${order.items.map(item => `<tr>
                  ...
                  <td align="left" width="20%" style="padding: 6px 12px;font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">${"₹"}{ item.product.price * 83}</td>
                </tr>`)
